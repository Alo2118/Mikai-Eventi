-- Fix create_app_user: include extensions schema in search_path
-- so crypt() and gen_salt() from pgcrypto are accessible
...
-- Re-grant execute after replacing the function
