      ...
      <table className="w-full text-sm border-collapse">
        <thead>
          <tr className="border-b border-gray-200">
            <th className="text-left py-3 pr-4 font-semibold text-gray-700 min-w-[180px]">Evento</th>
            {COLONNE.map(col => (
              <th key={col.key} className="text-center py-3 px-3 font-semibold text-gray-700 whitespace-nowrap min-w-[120px]">
                {col.label}
              </th>
            ))}
            <th className="text-center py-3 px-3 font-semibold text-gray-700 min-w-[80px]">Totale</th>
          </tr>
        </thead>
        <tbody>
            ...
            return (
              ...
              >
                <td className="py-3 pr-4">
                  <p className="font-medium text-gray-900 truncate max-w-[200px]">{evento.titolo}</p>
